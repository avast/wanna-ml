...
def wanna_sklearn_sample(eval_acc_threshold: float):
    ...
    ).set_display_name("Slack Notification").set_caching_options(False)
    ...
    with dsl.ExitHandler(exit_task):
        ...
        with dsl.Condition(
            ...
            model_upload_task = (
                ...
                ).set_display_name("Upload model").after(eval_op)
            )
            ...
            endpoint_create_task = (
                aip_components.EndpointCreateOp(
                    ...
                    labels=cfg.PIPELINE_LABELS,
                ).set_display_name("Create model endpoint").after(model_upload_task)
            )
            ...
            test_instances = [
                [36, 14.25, 21.72, 93.63, 633.0, 0.09823, 0.1098, 0.1319, 0.05598, 0.1885, 0.06125, 0.286, 1.019, 2.657,
                 24.91, 0.005878, 0.02995, 0.04815, 0.01161, 0.02028, 0.004022, 15.89, 30.36, 116.2, 799.6, 0.1446,
                 0.4238, 0.5186, 0.1447, 0.3591, 0.1014],
                [226, 10.44, 15.46, 66.62, 329.6, 0.1053, 0.07722, 0.006643, 0.01216, 0.1788, 0.0645, 0.1913, 0.9027, 1.208,
                 11.86, 0.006513, 0.008061, 0.002817, 0.004972, 0.01502, 0.002821, 11.52, 19.8, 73.47, 395.4, 0.1341,
                 0.1153, 0.02639, 0.04464, 0.2615, 0.08269]
            ]
