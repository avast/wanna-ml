...
from kfp import dsl
from kfp.dsl import component, importer, Model
...
def wanna_sklearn_sample(eval_acc_threshold: float, start_date: str, model_path: str):
    # ===================================================================
...
def wanna_sklearn_sample_eval(eval_acc_threshold: float, start_date: str, model_path: str):
    # ===================================================================
    # Get pipeline result notification
    # ===================================================================
    # collect datasets provided by sklearn
    ...
    with dsl.ExitHandler(exit_task):
        ...
        # Import the model from the provided path
        import_model_task = importer(
            artifact_uri=model_path,
            artifact_class=Model,
            metadata={
                "description": "Pre-trained XGBoost model"
            }
        ).set_display_name("Import XGBoost model")
        ...
        eval_op = eval_model_op(
            test_set=dataset_op.outputs["dataset_test"],
            xgb_model=import_model_task.outputs["artifact"],
        )
